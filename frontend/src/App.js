              ...
              <div className="row gh-1 gv-2 text-white">
                ...
                >
                  ...
                  <p className="lead fw-normal">
                    Working with CNN to help identify potential issues with
                    Brain cancer early.
                  </p>
                </div>
                  ...
                  <div className="card card-portfolio card-horizontal card-swap card-image-md card-hover-frame text-white">
                    ...
                    <div className="card-body">
                      ...
                      <div className="card-text">
                        ...
                        stages of brain cancer, doing its part in helping
                        adresss the issue regarding late identification.
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="row justify-content-between gh-1 gv-4 mb-30">
              <div className="col-lg-3">
                <ul className="nav flex-column text-white">
                  ...
                  <li className="nav-item">
                    <a
                      href="mailto:brainvisionai@gmail.com?subject=Test%20Address%20Email"
                      className="nav-link"
                    >
                      brainvisionai@gmail.com
                    </a>
                  </li>
                </ul>
              </div>
