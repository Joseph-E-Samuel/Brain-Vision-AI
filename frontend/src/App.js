                  ...
                  <div className="container">
                    <ul role="menu" className="navbar-nav row gh-1 gv-3">
                        ...
                        <span className="nav-item">
                          <a href="home.html" className="nav-link">
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/main-home.jpg"
                                alt=""
                              />
                            </span>
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a href="simple-portfolio.html" className="nav-link">
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/simple-portfolio.jpg"
                                alt=""
                              />
                            </span>
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2 active">
                        <span className="nav-item">
                          <a href="creative-agency.html" className="nav-link">
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/creative-agency.jpg"
                                alt=""
                              />
                            </span>
                            <span className="nav-link-name">
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a
                            href="freelancer-portfolio.html"
                            className="nav-link"
                          >
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/freelancer-portfolio.jpg"
                                alt=""
                              />
                            </span>
                            <span className="nav-link-name">
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a
                            href="interactive-links-dark.html"
                            className="nav-link"
                          >
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/interactive-dark.jpg"
                                alt=""
                              />
                            </span>
                            <span className="nav-link-name">
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a
                            href="interactive-links-light.html"
                            className="nav-link"
                          >
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/interactive-light.jpg"
                                alt=""
                              />
                            </span>
                            <span className="nav-link-name">
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a href="left-menu.html" className="nav-link">
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/left-menu.jpg"
                                alt=""
                              />
                            </span>
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a href="digital-agency.html" className="nav-link">
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/digital-agency.jpg"
                                alt=""
                              />
                            </span>
                            <span className="nav-link-name">
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a href="carousel-dark.html" className="nav-link">
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/carousel-dark.jpg"
                                alt=""
                              />
                            </span>
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a href="carousel-light.html" className="nav-link">
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/carousel-light.jpg"
                                alt=""
                              />
                            </span>
                            <span className="nav-link-name">
                      ...
                      <li className="col-md-6 col-lg-3 col-xl-2">
                        <span className="nav-item">
                          <a
                            href="fullscreen-showcase.html"
                            className="nav-link"
                          >
                            <span className="nav-link-image">
                              <img
                                src="assets/images/demos/fullscreen-showcase.jpg"
                                alt=""
                              />
                            </span>
                            <span className="nav-link-name">
              ...
              <li className="nav-item navbar-dropdown">
                ...
                <div className="dropdown-menu">
                  <ul className="nav navbar-nav">
                    <li className="nav-item navbar-dropdown">
                      <a
                        href="portfolio-col-1-style-1.html"
                        className="nav-link"
                      >
                      ...
                      <div className="dropdown-menu">
                        <ul className="nav navbar-nav">
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-1-style-2.html"
                              className="nav-link"
                            >
                    ...
                    <li className="nav-item navbar-dropdown">
                      <a
                        href="portfolio-col-2-style-1.html"
                        className="nav-link"
                      >
                      ...
                      <div className="dropdown-menu">
                        <ul className="nav navbar-nav">
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-2-style-2.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 2</span>
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-2-style-4.html"
                              className="nav-link"
                            >
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-2-style-5.html"
                              className="nav-link"
                            >
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-2-style-6.html"
                              className="nav-link"
                            >
                    ...
                    <li className="nav-item navbar-dropdown">
                      <a
                        href="portfolio-col-3-style-1.html"
                        className="nav-link"
                      >
                      ...
                      <div className="dropdown-menu">
                        <ul className="nav navbar-nav">
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-3-style-2.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 2</span>
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-3-style-3.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 3</span>
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-3-style-4.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 4</span>
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-3-style-5.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 5</span>
                            </a>
                    ...
                    <li className="nav-item navbar-dropdown">
                      <a
                        href="portfolio-col-4-style-1.html"
                        className="nav-link"
                      >
                      ...
                      <div className="dropdown-menu">
                        <ul className="nav navbar-nav">
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-4-style-2.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 2</span>
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-4-style-3.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 3</span>
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-col-4-style-4.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 4</span>
                            </a>
                    ...
                    <li className="nav-item navbar-dropdown">
                      ...
                      <div className="dropdown-menu">
                        <ul className="nav navbar-nav">
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-single-style-3.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 3</span>
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              href="portfolio-single-style-6.html"
                              className="nav-link"
                            >
                              <span className="nav-link-name">Style 6</span>
                            </a>
                    ...
                    <li className="nav-item navbar-collapse">
                      ...
                      >
                        <ul className="nav navbar-nav">
                          ...
                          <li className="nav-item navbar-collapse">
                            <a
                              href="#navbarCollapseSingleWorks"
                              className="nav-link collapsed"
                              role="button"
                              data-bs-toggle="collapse"
                              aria-expanded="false"
        ...
        <div className="content-wrap">
          <div className="pt-160 pb-100 position-relative">
            <div className="background">
              <div
                ...
                data-jarallax-video="mp4:assets/videos/creative-branding-studio.mp4"
              ></div>
              <div
                className="background-color"
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, rgba(14, 14, 14, 0) 0%, #0e0e0e 100%)",
                }}
              ></div>
            </div>
            <div className="container py-lg-2">
              <div className="row gh-1 gv-2 text-white">
                <div
                  className="col-lg-5 me-auto show-on-scroll"
                ...
                <div
                  className="col-lg me-xl-n30 show-on-scroll"
                  data-show-duration="900"
                  data-show-delay="150"
                >
                  <hr className="mt-0 border-white" />
                  <p className="lead fw-normal">
                    Working with CNN to help identify potential issues with lung
                    cancer early.
                  </p>
                </div>
          ...
          <div className="pb-160 bg-dark">
            <div className="container overflow-hidden">
              <div className="row">
                <div
                  className="col-12 mb-100 pb-5 show-on-scroll"
                ...
                >
                  <div className="card card-portfolio card-horizontal card-image-md card-hover-frame text-white">
                    ...
                    >
                      <img
                        src="assets/images/portfolio/funny-dog-1200-865.jpg"
                        alt=""
                      />
                    </a>
                    <div className="card-body">
                      ...
                      <div className="card-text">
                        The simplicity of our testing process allows patients
                        and hospitals alike to test and recieve accurate
                        results. Built to be simple, fast, and efficent to use.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="card card-portfolio card-horizontal card-swap card-image-md card-hover-frame text-white">
                    ...
                    >
                      <img
                        src="assets/images/portfolio/creative-branding-1200-865.jpg"
                        alt=""
                      />
                    </a>
                    <div className="card-body">
                      ...
                      <div className="card-text">
                        Our algorithim was trained using CT scans of early
                        stages of lung cancer, doing its part in helping adresss
                        the issue regarding late identification.
                      </div>
                    </div>
                  </div>
                </div>
                <div
                  className="col-12 mb-130 show-on-scroll"
                  data-show-duration="800"
                  data-show-delay="100"
                >
                  <div className="card card-portfolio card-horizontal card-image-md card-hover-frame text-white">
                    ...
                    >
                      <img
                        src="assets/images/portfolio/identity-design-1200-865.jpg"
                        alt=""
                      />
                    </a>
                    <div className="card-body">
                      ...
                      <div className="card-text">
                        Our algorithim works entirely off CT scans. Allows any
                        patient possessesing a CT scan and a internet connection
                        to test themselves.
                      </div>
                    </div>
                  </div>
          ...
          <div className="py-160 shape-parent overflow-hidden">
            ...
            <div className="container">
              <div className="row justify-content-xl-center gh-1 gv-5 mb-n7">
                <div
                  className="col-12 col-lg-4 me-lg-auto me-xl-0 show-on-scroll"
                  data-show-duration="900"
                >
                ...
                <div className="d-none d-xl-block col-1"></div>
                <div
                  className="col-12 col-lg-6 col-xl-5 show-on-scroll"
                  data-show-delay="150"
                  data-show-duration="900"
                >
                  <p className="lead fw-normal mt-n7 mb-30">
                    Simply drag and drop your image into the file box and press
                    the process button.
                  </p>
                  <p>
                    Your image will be processed within a span of two to three
                    seconds and your results will be shown below.
                  </p>
                  <hr />
              ...
              <a
                className="gallery-item gallery-item-sm mt-160 mb-60 show-on-scroll"
          ...
          <div className="container mb-n5">
            <div className="row justify-content-between mb-100 gh-1 gv-4">
              <div className="col-lg-3">
                ...
                <p className="mb-0">
                  Contact us at your lesuire with one of the following
                  platforms:
                </p>
              </div>
            ...
            <div className="row justify-content-between gh-1 gv-4 mb-30">
              <div className="col-lg-3">
                <ul className="nav flex-column text-white">
                  <li className="nav-item">
                    <a href="callto:+1 510-815-2306" className="nav-link">
                      +1 510-815-2306
                    </a>
                  </li>
                  <li className="nav-item">
                    <a
                      href="mailto:lungvisionai@gmail.com?subject=Test%20Address%20Email"
                      className="nav-link"
                    >
                      lungvisionai@gmail.com
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="row justify-content-between mt-100 mt-lg-0">
              ...
              <div className="col-auto">
                <div className="footer-copyright">
                  © 2020-2022 | Themebau by RunWebRun.
                </div>
              </div>
            </div>
          </div>
